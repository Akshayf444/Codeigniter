...
<div class="row   panel panel-default"  style="    padding-top: 24px;" >

    <div class="col-lg-6 " >
        <div class="form-group">
            <label class="col-sm-7 control-label">Name*</label><input type="text" style="width: 300px" required="required" value="<?php echo $user['name'];?>" class="form-control" placeholder="Enter Name" name="name"/>
        </div>
        <div class="form-group">
